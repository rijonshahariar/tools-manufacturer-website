...
const Offers = () => {
    return (
        <div>
            <div class="hero bg-primary text-white" style={{ backgroundImage: "url(" + "https://t4.ftcdn.net/jpg/04/31/19/89/360_F_431198909_DwGgs82ot1BTZ7wu6dnvwpBRTKVDZROd.jpg" + ")" }}>
