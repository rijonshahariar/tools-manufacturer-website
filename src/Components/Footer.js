...
const Footer = () => {
  return (
    <>
      ...
      <footer className="footer px-10 py-4 border-t bg-primary text-neutral-content border-base-300">
        <div className="items-center grid-flow-col">
          ...
          <p>ArcToolsBD Ltd. <br />Providing reliable service since 1992</p>
        </div>
